				  ...
				  stopPlayer2 = setInterval(function(){
					...
					if(document.querySelector('#fighter1').offsetLeft >= document.querySelector('#fighter2').offsetLeft){
							...
							if(parseInt(equal)>50){
								...
								setTimeout(function(){$('#fighter2').css('background-position',"-112px -185px")
						.css('z-index', 6)
								setTimeout(function(){$('#fighter2').css('background-position',"-231px -271px").css('width',"70px");
						setTimeout(function(){$('#fighter2').css('background-position',"-120px -271px")
						...
						setTimeout(function(){$('#fighter2').css('background-position',"-112px -13px");
