...
var stopPlayer2 = setInterval(function(){
	...
	if (parseInt(equal) > 50) {
		...
		for(var i=0; i < 4; i++){
			...
			setTimeout(fighter2FixMerginLeft.bind(null,
				fighter2FixMerginLeft.bind(null,
					function(){setTimeout(fighter2FixMerginLeft.bind(null, 
						function(){setTimeout(fighter2FixMerginLeft, player2timout)}
					),player2timout);
				},player2timout);
			},player2timout);
		}
