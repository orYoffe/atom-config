...
class DM_WidgetV3_PageItem_Masscast extends DM_WidgetV3
{
    ...
    private $allowedElement = array ('x01', 'Middle', 'Top', 'Top3', 'Right', 'x28', 'x29','x30', 'x69', 'x70', 'Bottom', 'BottomRight','x51','x52','x53', 'x02');

    // allowed position you can use to get a derivated
    private $allowedDerivated = array ('x01', 'Middle', 'Top', 'Right', 'x28','x29', 'x30', 'Bottom', 'Bottomright', 'x70');
