...
class VideoItem extends Component {
  ...
  render() {
    ...
    let caption
    if (isPlaylist) {
      caption = <div className="video-item__thumb__videos-total">videos_total <Trans context={this.trans} isPlural={videos_total !== 1}>videos</Trans></div>
    }
    else {
      if(locale){
        ...
        <div className="video-item__description">
          ...
          { !isPlaylist ?
            <p className="video-item__description__infos">
              ...
              <span className="video-item__description__views">
                {views_total} {live ?
                  <Trans context={this.trans} isPlural={views_total !== 1}>viewers</Trans>
                  : <Trans context={this.trans} isPlural={views_total !== 1}>views</Trans>}
                </span>
            </p>
          : null }
        </div>
