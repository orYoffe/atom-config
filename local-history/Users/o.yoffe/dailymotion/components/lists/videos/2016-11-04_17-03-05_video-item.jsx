        ...
        <div className="video-item__description">
          ...
          { !isPlaylist ?
            <p className="video-item__description__infos">
              {!live ? (<span className="video-item__description__ago">{ ago }</span>
            <span className="video-item__description__sep">•</span>) : null }
              <span className="video-item__description__views">{ views_total  + ' ' + (live ? this.trans.viewers : this.trans.views)}</span>
            </p>
          : null }
        </div>
