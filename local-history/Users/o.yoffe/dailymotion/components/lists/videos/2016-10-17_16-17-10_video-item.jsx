...
class VideoItem extends Component {
  ...
  render() {
    ...
    let { isPlaylist, className, owner, title, name, duration, thumbnails, views_total, created_date, html_url, videos_total, content_type } = this.props
      ...
      <div className={classNames.join(' ')} >
        ...
        <div className="video-item__description">
          ...
          <p className="video-item__description__channel">
            {this.trans.by} <a href={"/"+owner.username} >{ owner.fullname }<VerifiedBadge verified={content_type === "verified-partner"} /></a>
          </p>
          { !isPlaylist ?
