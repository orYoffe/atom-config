...
class VideoItem extends Component {
  ...
  render() {
    ...
    const username = owner ? owner.username : this.props['owner.url'].substr(this.props['owner.url'].lastIndesOf('com/') + 3)
      ...
      <div className={classNames.join(' ')} >
        ...
        <div className="video-item__description">
          ...
          <p className="video-item__description__channel">
            {this.trans.by} <a href={"/"+owner.username} onClick={navigate.bind(this, query, "/"+owner.username)}  >{ fullname }<VerifiedBadge verified={content_type === "verified-partner"} /></a>
          </p>
          { !isPlaylist ?
