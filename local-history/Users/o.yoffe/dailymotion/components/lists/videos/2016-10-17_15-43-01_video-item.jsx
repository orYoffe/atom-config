...
class VideoItem extends Component {
  ...
  render() {
    ...
    let ago = moment(created_date).fromNow()
    ...
    let caption
    if (isPlaylist) {
      caption = <div className="video-item__thumb__videos-total">{ videos_total }VIDEOS</div>
    }
    else {
      caption = live ? <div className="video-item__thumb__live">LIVE</div> : <div className="video-item__thumb__duration">{ duration }</div> 
    }
