      ...
      <div className={classNames.join(' ')} >
        ...
        <div className="video-item__description">
          ...
          <p className="video-item__description__channel">
            {this.trans.by} <a href={"/"+owner.username} onClick={navigate.bind(this, query, "/"+owner.username)}  >{ owner.fullname }<VerifiedBadge verified={content_type === "verified-partner"} /></a>
          </p>
          { !isPlaylist ?
