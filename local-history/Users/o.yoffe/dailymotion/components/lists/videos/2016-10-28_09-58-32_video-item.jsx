...
class VideoItem extends Component {
  ...
  render() {
    ...
    if (isPlaylist) {
      ...
      caption = live ? <div className="video-item__thumb__live">{this.trans.Live && this.trans.Live.toUpperCase()}: {this.props.start_time}</div> : <div className="video-item__thumb__duration">{ duration }</div>
    }
