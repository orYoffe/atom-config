...
export default class ASearchPopout extends Component {
  ...
  componentWillMount() {
    this.search(this.props)
      ...
      console.log('as---------3--------', this.refs.popup);
      console.log('as---------3--------', this.refs._popup);
  }

  componentWillReceiveProps(nextProps) {
    console.log('as---------1--------', this.refs.popup);
    console.log('as---------1--------', this.refs._popup);
  ...
  componentDidMount() {
    console.log('as---------2--------', this.refs.popup);
    console.log('as---------2--------', this.refs._popup);
...
// console.log('-----------------asdasdasdas',wrapper)
  ...
  render() {
    ...
    return (
      <div className="a-search__popout" ref={(c) => this._popup = c}>
