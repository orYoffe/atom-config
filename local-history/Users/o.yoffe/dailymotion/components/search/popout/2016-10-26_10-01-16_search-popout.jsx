...
console.log({ fetching, totalResults, videos, lives, playlists, users, query, selectedTab });
    ...
    return (
      <div className="a-search__popout">
        <InfiniteScroll isFetching={fetching} loadNextPage={this.loadNextPage.bind(this)} hasMore={this.state.hasMore} containerClassName="a-search__popout">
        <div className="a-search__popout__content">
          <a href="" className="a-search__popout__close" onClick={::this.onClose} >
            <i className="icon-close" ></i>
          </a>
