...
export default class ASearchPopout extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    console.debug(nextProps.query !== this.props.query || nextProps.selectedTab !== this.props.selectedTab, nextProps.query ,this.props.query, nextProps.selectedTab, this.props.selectedTab)
