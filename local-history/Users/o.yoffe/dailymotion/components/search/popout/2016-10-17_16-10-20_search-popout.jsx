...
export default class ASearchPopout extends Component {
  ...
  render() {
    ...
    let dataNav = [
      ...
      { link: <Link to={`/search/${query}/videos`}>{this.trans.videos && this.trans.videos.toUpperCase()}</Link>, content: <SearchVideos videos={videos} /> },
      { link: <Link to={`/search/${query}/channels`}>{this.trans.channels && this.trans.channels.toUpperCase()}</Link>, content: <SearchChannels users={users} /> },
      { link: <Link to={`/search/${query}/playlists`}>{this.trans.playlists && this.trans.playlists.toUpperCase()}</Link>, content: <div>playlists</div> },
    ]
