...
export default class ASearchPopout extends Component {
  ...
  componentDidMount() {
    console.log('as-----------------', this.refs.popup));
    console.log('as2-----------------', this.refs.popup2));
    console.log('as3-----------------', this.refs.popup3));
...
console.log('-----------------asdasdasdas',wrapper)
  ...
  componentWillUnmount() {
      const popup = React.DOM.findDOMNode(this.refs.popu)
  ...
  render() {
    ...
    return (
      <div className="a-search__popout" ref="popup">
        <div className="a-search__popout__content" ref="popup2">
