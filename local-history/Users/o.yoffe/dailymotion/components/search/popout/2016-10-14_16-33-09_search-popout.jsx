...
=======
    let { fetching, totalResults, videos } = this.state
>>>>>>> bce06b66f6a1bb6dd863f0c9d388d3122e936054
...
=======
      { link: <Link to={`/search/${query}/all`}>All</Link>, content: <TabAll results={this.state} query={query} /> },
