    ...
    return (
      <div className="search-all">
        ...
        <div className="search-all__lists">
          ...
          {videos1 && videos1.length ? <div className="search-all__videos">
            <GridList
              columns={playlists && playlists.length ? 2 : 3}
              margins={10}
              marginBottom={20}
              fetching={fetching}
          ...
          {playlists && playlists.length ? <div className="search-all__playlists">
          ...
          <GridList
            columns={videos1 && videos1.length ? 1 : 3}
            margins={10}
            marginBottom={20}
            fetching={fetching}
