    ...
    return (
      <div className="a-search__no-results">
        <div className="a-search__no-results__header">
          <p>{this.trans.no_results + ' ' + this.props.query}</p>
          <Trans className="a-search__no-results__main-header" context={this.trans} search_label={this.props.query}>No results found for %(search_label)s</Trans>
