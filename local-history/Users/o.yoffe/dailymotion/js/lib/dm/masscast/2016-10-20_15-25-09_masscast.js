        ...
        callOAS : function(positions)
        {
            ...
            $
                ...
                .done(function(OASResponse)
                {
                    ...
                    if (positions && positions.length && (positions.indexOf('Middle') !== -1 || positions.indexOf('X01') !== -1))
                    {
        ...
        handlePositionCodes: function(positionCodes)
        {
            ...
            for (var position in positionCodes)
            {
                ...
                try
                {
                    ...
                    if (!positionCode || positionCode.toLowerCase().indexOf('default ad') > -1)
                    {
