...
_DM.define('DM_DisplayAds', function()
{
    var _self = {
        ...
        [
            ...
            {'pos':'X01','id':'div-gpt-ad-1422660696836-4','name':'X01_300x250','dimensions':[300,250]},
        ...
        companionAdPresent: function() {
            return ($('div[id^="mc_"]').length > 0 && ($('#mc_Middle').children().length > 0 || $('#mc_Middle').children().length > 0));
        }
    };
